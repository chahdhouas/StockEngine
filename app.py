...
st.markdown("""
    ...
    /* Bulles d'alerte de stock (badges) — pilules statiques et uniformes,
       sans aucune affordance de clic (ni curseur pointeur, ni effet hover/
       focus, ni ombre "bouton"). Le point de couleur est dessiné en CSS
       (::before), pas en emoji, pour un rendu identique sur tous les
       navigateurs/OS et pour éviter l'effet "interrupteur". */
    .badge {
        display: inline-flex;
        align-items: center;
        gap: 6px;
